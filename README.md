...
## I'm using a course by David Beazley to strengthen up my Python skills. This is a repository to keep track of progress. All of my own solutions can be found in mySolutions. From below onwards, it is the exact information forked from the course.
